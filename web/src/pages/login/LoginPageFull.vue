...
/**
 * LoginPageFull - Full Login Page with both Firebase (Google + Email) and LP SSO
 *
 * This is the complete login page offering all authentication methods:
 * - Google OAuth (via Firebase)
 * - Email/Password (via Firebase)
 * - LP SSO (legacy direct LP authentication)
 *
 * Use this variant when you want to give users maximum flexibility in how they authenticate.
 */
