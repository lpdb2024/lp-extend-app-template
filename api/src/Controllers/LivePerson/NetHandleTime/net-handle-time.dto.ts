/**
 * Net Handle Time API DTOs
 * NestJS DTOs for Net Handle Time API request/response validation
 */
...
export class AgentSegmentsQueryDto {
  ...
  @ApiPropertyOptional({
    ...
    enum: NHTSegmentSortField,
  })
  @IsOptional()
  @IsEnum(NHTSegmentSortField)
 ...
 */
export class NHTAgentSegmentsResponseDto {
  @ApiProperty({ description: 'Agent segments response data' })
  data: INHTAgentSegmentsResponse;
}

/**
 * Breakdown files response DTO
 */
export class NHTBreakdownFilesResponseDto {
  @ApiProperty({ description: 'Breakdown files list response data' })
  data: INHTBreakdownFilesResponse;
}

/**
 * Breakdown file response DTO
 */
export class NHTBreakdownFileResponseDto {
  @ApiProperty({ description: 'NHU breakdown records' })
  data: INHUBreakdownRecord[];
}
